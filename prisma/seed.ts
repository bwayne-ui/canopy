...
async function main() {
  ...
  console.log('Created ILPA transaction parameters (core 28)');

  // ── Extended transaction parameters: Capital Call gaps, new categories ──
  await prisma.transactionParameter.createMany({ data: [
    // ── CAPITAL CALL — ADDITIONAL SUBTYPES ────────────────────────────
    { code: 'CC-FOLLOWON', sortOrder: 15, name: 'Capital Call: Follow-On Investment', ilpaCategory: 'Capital Call', ilpaSubtype: 'CC — Follow-On Investment', ilpaTemplateRef: tpRef, direction: 'Inflow', insideFund: true, recallable: false, navImpact: 'Increase NAV', glDebit: 'Cash & Cash Equivalents', glCredit: 'Capital Contributions — LP', journalType: 'JE-CC-FOL', perfTemplateClass: 'Contribution', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'Return of Capital', commitmentImpact: 'Reduces Unfunded', settlementDays: 'T+3', autoReconcile: true, approvalRequired: true, taxReporting: 'Schedule K-1 — Item L', notes: 'Capital call for add-on / follow-on investment into an existing portfolio company. Treated identically to CC-INV but tagged separately for attribution analytics.' },
    { code: 'CC-COINVEST', sortOrder: 16, name: 'Capital Call: Co-Investment Allocation', ilpaCategory: 'Capital Call', ilpaSubtype: 'CC — Co-Investment', ilpaTemplateRef: tpRef, direction: 'Inflow', insideFund: true, recallable: false, navImpact: 'Increase NAV', glDebit: 'Cash & Cash Equivalents', glCredit: 'Capital Contributions — Co-Invest LP', journalType: 'JE-CC-COIN', perfTemplateClass: 'Contribution', perfTemplateMethod: 'Granular', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'Return of Capital', commitmentImpact: 'Reduces Unfunded', settlementDays: 'T+3', autoReconcile: true, approvalRequired: true, taxReporting: 'Schedule K-1 — Item L', notes: 'Capital call to SPV or sidecar co-invest vehicle. Tracked separately from main fund. ILPA encourages GP disclosure of co-invest economics alongside main fund.' },
    { code: 'CC-ORGCOST', sortOrder: 17, name: 'Capital Call: Organizational Costs', ilpaCategory: 'Capital Call', ilpaSubtype: 'CC — Organizational Costs', ilpaTemplateRef: tpRef, direction: 'Inflow', insideFund: true, recallable: false, navImpact: 'No NAV Impact', glDebit: 'Cash & Cash Equivalents', glCredit: 'Formation & Organization Expense Payable', journalType: 'JE-CC-ORG', perfTemplateClass: 'Fee', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'Reduces Unfunded', settlementDays: 'T+3', autoReconcile: true, approvalRequired: false, taxReporting: 'Schedule K-1 — Item F', notes: 'Capital call for fund formation, entity registration, and initial legal costs. Amortized over fund life under US GAAP. Common in first capital call.' },
    { code: 'CC-PLCMT', sortOrder: 18, name: 'Capital Call: Placement Agent Fees', ilpaCategory: 'Capital Call', ilpaSubtype: 'CC — Placement Agent', ilpaTemplateRef: tpRef, direction: 'Inflow', insideFund: true, recallable: false, navImpact: 'No NAV Impact', glDebit: 'Cash & Cash Equivalents', glCredit: 'Placement Fee Payable', journalType: 'JE-CC-PLCMT', perfTemplateClass: 'Fee', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'Reduces Unfunded', settlementDays: 'T+3', autoReconcile: true, approvalRequired: false, taxReporting: 'Schedule K-1 — Item F', notes: 'Capital call for upfront placement agent retainer and trailing commissions. Covered by ILPA guidance — must be disclosed gross. Often rebated to LPs via fee offset.' },
    { code: 'CC-BRIDGEREPAY', sortOrder: 19, name: 'Capital Call: Bridge Facility Repayment', ilpaCategory: 'Capital Call', ilpaSubtype: 'CC — Bridge Repayment', ilpaTemplateRef: tpRef, direction: 'Inflow', insideFund: true, recallable: false, navImpact: 'No NAV Impact', glDebit: 'Cash & Cash Equivalents', glCredit: 'Subscription Credit Facility Payable', journalType: 'JE-CC-BRIDGE', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'Reduces Unfunded', settlementDays: 'T+3', autoReconcile: true, approvalRequired: true, taxReporting: 'None', notes: 'LP capital called specifically to repay outstanding subscription credit facility balance. ILPA requires dual IRR disclosure showing impact of sub-line timing.' },
    { code: 'CC-CLWBK', sortOrder: 20, name: 'Capital Call: Clawback Funding', ilpaCategory: 'Capital Call', ilpaSubtype: 'CC — Clawback Funding', ilpaTemplateRef: tpRef, direction: 'Inflow', insideFund: false, recallable: false, navImpact: 'No NAV Impact', glDebit: 'Cash & Cash Equivalents', glCredit: 'Clawback Receivable — GP', journalType: 'JE-CC-CLWBK', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+5', autoReconcile: false, approvalRequired: true, taxReporting: 'None', notes: 'GP funds clawback escrow or repays over-distributed carry. Outside Fund transaction. ILPA Sept 2025 guidance: must be shown separately in CC&D template.' },
    // ── DISTRIBUTIONS — ADDITIONAL SUBTYPES ───────────────────────────
    { code: 'DIST-INC', sortOrder: 28, name: 'Distribution: Income (Interest & Dividends)', ilpaCategory: 'Distribution', ilpaSubtype: 'Dist — Income', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'Investment Income — Net', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-DIST-INC', perfTemplateClass: 'Distribution', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'Preferred Return', commitmentImpact: 'No Impact', settlementDays: 'T+5', autoReconcile: true, approvalRequired: true, taxReporting: 'Schedule K-1 — Items 5/6a', notes: 'Periodic income distributions from portfolio cash flows — interest on debt instruments, dividends from portfolio companies. Often tax-first in European waterfall.' },
    { code: 'DIST-PREF', sortOrder: 29, name: 'Distribution: Preferred Return', ilpaCategory: 'Distribution', ilpaSubtype: 'Dist — Preferred Return', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'Preferred Return Payable — LP', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-DIST-PREF', perfTemplateClass: 'Distribution', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'Preferred Return', commitmentImpact: 'No Impact', settlementDays: 'T+5', autoReconcile: true, approvalRequired: true, taxReporting: 'Schedule K-1 — Item 5', notes: 'Distribution satisfying the LP preferred return / hurdle. Accrues at compound rate (typically 8%) on contributed capital. No carry allocated until pref is cleared.' },
    { code: 'DIST-EXRET', sortOrder: 30, name: 'Distribution: Excess Return (Post-Carry)', ilpaCategory: 'Distribution', ilpaSubtype: 'Dist — Excess Return', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'Capital Account — LP (Profit Share)', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-DIST-EXRET', perfTemplateClass: 'Distribution', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'Carried Interest', commitmentImpact: 'No Impact', settlementDays: 'T+5', autoReconcile: true, approvalRequired: true, taxReporting: 'Schedule K-1 — Item 9a', notes: 'LP\'s 80% (or LPA-specified) share of profits above the GP catch-up tier. Final waterfall tier before fund wind-down. Subject to carry true-up.' },
    { code: 'DIST-CLWBK', sortOrder: 31, name: 'Distribution: Clawback Recovery (LP Receipt)', ilpaCategory: 'Distribution', ilpaSubtype: 'Dist — Clawback Recovery', ilpaTemplateRef: tpRef, direction: 'Inflow', insideFund: false, recallable: false, navImpact: 'Increase NAV', glDebit: 'Clawback Receivable — GP', glCredit: 'Clawback Recovery Income — LP', journalType: 'JE-DIST-CLWBK', perfTemplateClass: 'Distribution', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+5', autoReconcile: false, approvalRequired: true, taxReporting: 'Schedule K-1 — Item L', notes: 'Return of previously distributed carry from GP to LPs. Triggered when net realized returns fall short of preferred return. ILPA Sept 2025: must be detailed in CC&D template.' },
    { code: 'DIST-SPOCKET', sortOrder: 32, name: 'Distribution: Side Pocket Realization', ilpaCategory: 'Distribution', ilpaSubtype: 'Dist — Side Pocket', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'Side Pocket Account — LP', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-DIST-SP', perfTemplateClass: 'Distribution', perfTemplateMethod: 'Granular', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'Return of Capital', commitmentImpact: 'No Impact', settlementDays: 'T+5', autoReconcile: false, approvalRequired: true, taxReporting: 'Schedule K-1 — Item 9a', notes: 'Proceeds from liquidation of side pocket assets (illiquid, difficult-to-value). Applicable to hedge funds and certain PE structures. Separated from main fund NAV.' },
    { code: 'DIST-TENDER', sortOrder: 33, name: 'Distribution: Tender Offer / LP Buyback', ilpaCategory: 'Distribution', ilpaSubtype: 'Dist — Tender / Buyback', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: false, recallable: false, navImpact: 'No NAV Impact', glDebit: 'LP Interest Payable — Buyback', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-DIST-TDR', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+5', autoReconcile: false, approvalRequired: true, taxReporting: 'None', notes: 'GP-sponsored tender offer where fund buys back LP interests at NAV (discount). Increasingly common in GP-led secondary restructurings. Outside Fund classification.' },
    { code: 'DIST-RECAP', sortOrder: 34, name: 'Distribution: Dividend Recapitalization', ilpaCategory: 'Distribution', ilpaSubtype: 'Dist — Dividend Recap', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: true, navImpact: 'Decrease NAV', glDebit: 'Capital Account — LP (Recallable)', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-DIST-RECAP', perfTemplateClass: 'Distribution', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'Return of Capital', commitmentImpact: 'Restores Unfunded', settlementDays: 'T+5', autoReconcile: false, approvalRequired: true, taxReporting: 'Schedule K-1 — Item L', notes: 'Proceeds distributed from a portfolio company dividend recap (debt-financed dividend). Typically recallable. Impacts DPI and IRR timing significantly — ILPA requires separate disclosure.' },
    { code: 'DIST-WINDING', sortOrder: 35, name: 'Distribution: Wind-Down / Final Liquidation', ilpaCategory: 'Distribution', ilpaSubtype: 'Dist — Final Liquidation', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'Capital Account — LP', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-DIST-WIND', perfTemplateClass: 'Distribution', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'Return of Capital', commitmentImpact: 'No Impact', settlementDays: 'T+5', autoReconcile: false, approvalRequired: true, taxReporting: 'Schedule K-1 — Items L/9a/9c', notes: 'Final distribution upon fund dissolution, after all assets liquidated and obligations settled. Includes reserve release. Triggers K-1 finalization and fund accounting close-out.' },
    // ── FEE & EXPENSE — ADDITIONAL SUBTYPES ───────────────────────────
    { code: 'EXP-BROKEN', sortOrder: 43, name: 'Broken Deal / Abort Fee', ilpaCategory: 'Fee & Expense', ilpaSubtype: 'Expense — Broken Deal', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'Broken Deal Expense', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-EXP-BRK', perfTemplateClass: 'Fee', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+30', autoReconcile: false, approvalRequired: true, taxReporting: 'Schedule K-1 — Item F', notes: 'Diligence, legal, and advisory costs incurred on transactions that did not close. LP-level disclosure required per ILPA RT v2.0. Reduces invested capital basis.' },
    { code: 'EXP-COMPLIANCE', sortOrder: 44, name: 'Regulatory Compliance & Reporting Costs', ilpaCategory: 'Fee & Expense', ilpaSubtype: 'Expense — Compliance & Regulatory', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'Compliance & Regulatory Expense', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-EXP-COMP', perfTemplateClass: 'Fee', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+30', autoReconcile: true, approvalRequired: false, taxReporting: 'Schedule K-1 — Item F', notes: 'Costs of regulatory filings: Form ADV, Form PF, AIFMD Annex IV, FATCA/CRS compliance. NEW ILPA RT v2.0 standalone category.' },
    { code: 'EXP-CUSTODY', sortOrder: 45, name: 'Custody & Prime Brokerage Fees', ilpaCategory: 'Fee & Expense', ilpaSubtype: 'Expense — Custody', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'Custody Fee Expense', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-EXP-CUST', perfTemplateClass: 'Fee', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+30', autoReconcile: true, approvalRequired: false, taxReporting: 'Schedule K-1 — Item F', notes: 'Custodian safekeeping fees, prime broker margin/financing, and securities lending costs. Required separate disclosure for hedge funds and credit funds with leveraged strategies.' },
    { code: 'EXP-DATA', sortOrder: 46, name: 'Technology, Data & Software Expense', ilpaCategory: 'Fee & Expense', ilpaSubtype: 'Expense — Technology & Data', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'Technology & Data Expense', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-EXP-DATA', perfTemplateClass: 'Fee', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+30', autoReconcile: true, approvalRequired: false, taxReporting: 'Schedule K-1 — Item F', notes: 'Bloomberg, FactSet, portfolio monitoring platform subscriptions, and data vendor costs charged at fund level. Growing category as GPs adopt AI-powered analytics tools.' },
    { code: 'FEE-PERF', sortOrder: 47, name: 'Performance Fee / Incentive Allocation (Hedge Fund)', ilpaCategory: 'Fee & Expense', ilpaSubtype: 'Fee — Performance Fee', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'Performance Fee Expense', glCredit: 'Incentive Allocation Payable — GP', journalType: 'JE-FEE-PERF', perfTemplateClass: 'Carried Interest', perfTemplateMethod: 'Gross Up', feeOffset: false, feeOffsetType: 'Carry Basis', waterfallTier: 'Carried Interest', commitmentImpact: 'No Impact', settlementDays: 'T+0', autoReconcile: true, approvalRequired: true, taxReporting: 'Schedule K-1 — Item 1', notes: 'Hedge fund incentive allocation — typically 20% of profits above high-water mark. Accrued monthly, crystallized annually or quarterly. High-water mark tracking required.' },
    { code: 'FEE-ESG', sortOrder: 48, name: 'ESG-Linked Fee Adjustment', ilpaCategory: 'Fee & Expense', ilpaSubtype: 'Fee — ESG Adjustment', ilpaTemplateRef: tpRef, direction: 'Bilateral', insideFund: true, recallable: false, navImpact: 'No NAV Impact', glDebit: 'Management Fee Expense', glCredit: 'ESG Fee Rebate — LP', journalType: 'JE-FEE-ESG', perfTemplateClass: 'Fee', perfTemplateMethod: 'Both', feeOffset: true, feeOffsetType: 'Management Fee Base', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+0', autoReconcile: false, approvalRequired: true, taxReporting: 'Schedule K-1 — Item F', notes: 'Management fee discount or premium tied to ESG KPI performance (e.g., SFDR Article 8/9 targets). Bilateral — can be a rebate (Inflow to LPs) or surcharge. Emerging LPA term.' },
    { code: 'FEE-ADMIN', sortOrder: 49, name: 'Fund Administration Fee (Third-Party)', ilpaCategory: 'Fee & Expense', ilpaSubtype: 'Fee — Fund Administration', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'Fund Administration Expense', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-FEE-ADMIN', perfTemplateClass: 'Fee', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+30', autoReconcile: true, approvalRequired: false, taxReporting: 'Schedule K-1 — Item F', notes: 'Fees paid to third-party fund administrator (Juniper Square, SS&C, Citco, etc.) for NAV computation, investor servicing, and financial reporting. Typically AUM-based pricing.' },
    // ── CARRIED INTEREST — ADDITIONAL SUBTYPES ────────────────────────
    { code: 'CARRY-CLWBK', sortOrder: 54, name: 'Carried Interest: Clawback Obligation', ilpaCategory: 'Carried Interest', ilpaSubtype: 'Carry — Clawback', ilpaTemplateRef: tpRef, direction: 'Inflow', insideFund: false, recallable: false, navImpact: 'GP Allocation', glDebit: 'Clawback Receivable — GP', glCredit: 'Carried Interest Clawback Reserve', journalType: 'JE-CARRY-CLWBK', perfTemplateClass: 'Carried Interest', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'Carry Basis', waterfallTier: 'Carried Interest', commitmentImpact: 'No Impact', settlementDays: 'T+0', autoReconcile: false, approvalRequired: true, taxReporting: 'Schedule K-1 — Item 1', notes: 'Recognition of GP clawback obligation when cumulative carry distributions exceed final LPA entitlement. Booked as GP payable. Often held in escrow until fund wind-down.' },
    { code: 'CARRY-WAIVER', sortOrder: 55, name: 'Carried Interest: Waiver / Forgiveness', ilpaCategory: 'Carried Interest', ilpaSubtype: 'Carry — Waiver', ilpaTemplateRef: tpRef, direction: 'N/A', insideFund: true, recallable: false, navImpact: 'Increase NAV', glDebit: 'Carried Interest Payable — GP', glCredit: 'Carry Waiver Gain — LP', journalType: 'JE-CARRY-WAV', perfTemplateClass: 'Carried Interest', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+0', autoReconcile: false, approvalRequired: true, taxReporting: 'Schedule K-1 — Item 1', notes: 'GP elects to waive or forgive a portion of accrued carry — typically as GP commitment to retain LP relationships. Results in NAV transfer from GP to LP allocations.' },
    { code: 'CARRY-ESC', sortOrder: 56, name: 'Carried Interest: Escrow Deposit / Release', ilpaCategory: 'Carried Interest', ilpaSubtype: 'Carry — Escrow', ilpaTemplateRef: tpRef, direction: 'Bilateral', insideFund: false, recallable: false, navImpact: 'No NAV Impact', glDebit: 'Carry Escrow Account', glCredit: 'Carried Interest Payable — GP', journalType: 'JE-CARRY-ESC', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'Carried Interest', commitmentImpact: 'No Impact', settlementDays: 'T+0', autoReconcile: false, approvalRequired: true, taxReporting: 'None', notes: 'Deposit into (or release from) GP clawback escrow account. LPAs increasingly require 15-30% of carry held in escrow until fund wind-down to fund potential clawback.' },
    // ── FACILITY / DEBT — ADDITIONAL SUBTYPES ─────────────────────────
    { code: 'FACIL-NAV-DRAW', sortOrder: 63, name: 'NAV Facility: Draw', ilpaCategory: 'Facility / Debt', ilpaSubtype: 'NAV Facility — Draw', ilpaTemplateRef: tpRef, direction: 'Inflow', insideFund: true, recallable: false, navImpact: 'No NAV Impact', glDebit: 'Cash & Cash Equivalents', glCredit: 'NAV Facility Payable', journalType: 'JE-NAVF-DRAW', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+0', autoReconcile: true, approvalRequired: true, taxReporting: 'None', notes: 'Draw on NAV-based credit facility — collateralized by portfolio NAV rather than LP commitments. Used in late-stage funds for liquidity without LP capital calls. ILPA 2024 guidance requires comprehensive disclosure.' },
    { code: 'FACIL-NAV-REPAY', sortOrder: 64, name: 'NAV Facility: Repayment', ilpaCategory: 'Facility / Debt', ilpaSubtype: 'NAV Facility — Repayment', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'No NAV Impact', glDebit: 'NAV Facility Payable', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-NAVF-REPAY', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+0', autoReconcile: true, approvalRequired: true, taxReporting: 'None', notes: 'Principal repayment of NAV facility. Funded from distributions, asset sales, or LP capital calls. Reduces leverage ratio. ILPA LTV covenant monitoring required.' },
    { code: 'FACIL-BRIDGE', sortOrder: 65, name: 'Bridge / Mezzanine Financing Draw', ilpaCategory: 'Facility / Debt', ilpaSubtype: 'Facility — Bridge / Mezzanine', ilpaTemplateRef: tpRef, direction: 'Inflow', insideFund: true, recallable: false, navImpact: 'Increase NAV', glDebit: 'Cash & Cash Equivalents', glCredit: 'Bridge Loan Payable', journalType: 'JE-FACIL-BRG', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+0', autoReconcile: false, approvalRequired: true, taxReporting: 'None', notes: 'Short-term bridge or mezzanine financing at portfolio company or fund level. Interim liquidity between capital calls. Interest accrues as EXP-SUB or EXP-PROF.' },
    { code: 'FACIL-FX', sortOrder: 66, name: 'FX Hedge Settlement (Currency Forward / Option)', ilpaCategory: 'Facility / Debt', ilpaSubtype: 'Facility — FX Hedge', ilpaTemplateRef: tpRef, direction: 'Bilateral', insideFund: true, recallable: false, navImpact: 'Bilateral', glDebit: 'FX Hedge Gain / Loss', glCredit: 'FX Derivative Liability / Asset', journalType: 'JE-FX-HEDGE', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+2', autoReconcile: false, approvalRequired: true, taxReporting: 'Schedule K-1 — Item 11 (Sec 988)', notes: 'Settlement of currency forward, option, or swap hedging non-base currency exposures. Gain/loss recognized at settlement. Gross FX exposure must be reported in AIFMD Annex IV.' },
    // ── GP SECONDARY & RESTRUCTURING ──────────────────────────────────
    { code: 'SEC-RESTRCT', sortOrder: 100, name: 'GP-Led Fund Restructuring', ilpaCategory: 'GP Secondary & Restructuring', ilpaSubtype: 'Secondary — Fund Restructuring', ilpaTemplateRef: 'ILPA GP-Led Secondary Guidance Apr 2019', direction: 'Bilateral', insideFund: false, recallable: false, navImpact: 'No NAV Impact', glDebit: 'Restructured Fund Interest — Old', glCredit: 'Continuation Vehicle Interest — New', journalType: 'JE-SEC-REST', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+30', autoReconcile: false, approvalRequired: true, taxReporting: 'None', notes: 'GP initiates restructuring of fund via secondary — LPs offered cash exit or rollover into continuation vehicle. Requires LP advisory committee vote and independent valuation. ILPA requires conflict-of-interest disclosure.' },
    { code: 'SEC-CONTINUATION', sortOrder: 101, name: 'Continuation Vehicle / Rollover Transaction', ilpaCategory: 'GP Secondary & Restructuring', ilpaSubtype: 'Secondary — Continuation Vehicle', ilpaTemplateRef: 'ILPA GP-Led Secondary Guidance Apr 2019', direction: 'Bilateral', insideFund: false, recallable: false, navImpact: 'No NAV Impact', glDebit: 'Assets Transferred to Continuation Vehicle', glCredit: 'Continuation Vehicle Interests — LP', journalType: 'JE-SEC-CONT', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+30', autoReconcile: false, approvalRequired: true, taxReporting: 'None', notes: 'Transfer of select portfolio assets to new continuation vehicle, allowing rolling LPs extended hold period and exiting LPs liquidity. Requires independent fairness opinion.' },
    { code: 'SEC-TENDER', sortOrder: 102, name: 'LP Tender Offer (GP-Sponsored Secondary)', ilpaCategory: 'GP Secondary & Restructuring', ilpaSubtype: 'Secondary — LP Tender', ilpaTemplateRef: 'ILPA GP-Led Secondary Guidance Apr 2019', direction: 'Outflow', insideFund: false, recallable: false, navImpact: 'No NAV Impact', glDebit: 'LP Interest — Exiting', glCredit: 'Cash & Cash Equivalents (Secondary Buyer)', journalType: 'JE-SEC-TDR', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+10', autoReconcile: false, approvalRequired: true, taxReporting: 'None', notes: 'GP facilitates tender of LP interests to secondary buyer at negotiated price (typically 85-95% of NAV). Common mechanism for providing interim liquidity in end-of-life funds.' },
    { code: 'SEC-ANNEX', sortOrder: 103, name: 'Annex Fund Formation', ilpaCategory: 'GP Secondary & Restructuring', ilpaSubtype: 'Secondary — Annex Fund', ilpaTemplateRef: 'ILPA GP-Led Secondary Guidance Apr 2019', direction: 'Inflow', insideFund: false, recallable: false, navImpact: 'Increase NAV', glDebit: 'Cash & Cash Equivalents — Annex Fund', glCredit: 'Capital Contributions — Annex LPs', journalType: 'JE-SEC-ANNEX', perfTemplateClass: 'Contribution', perfTemplateMethod: 'Granular', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'Return of Capital', commitmentImpact: 'Reduces Unfunded', settlementDays: 'T+5', autoReconcile: false, approvalRequired: true, taxReporting: 'Schedule K-1 — Item L', notes: 'Capital raised from new LPs into an annex/stapled fund alongside a GP-led secondary. Provides fresh capital for portfolio investments while existing LPs get liquidity option.' },
    { code: 'SEC-STAPLED', sortOrder: 104, name: 'Stapled Secondary Transaction', ilpaCategory: 'GP Secondary & Restructuring', ilpaSubtype: 'Secondary — Stapled', ilpaTemplateRef: 'ILPA GP-Led Secondary Guidance Apr 2019', direction: 'Bilateral', insideFund: false, recallable: false, navImpact: 'No NAV Impact', glDebit: 'Secondary Sale Proceeds', glCredit: 'New Fund Commitment — Stapled LP', journalType: 'JE-SEC-STPL', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'Increases Unfunded', settlementDays: 'T+10', autoReconcile: false, approvalRequired: true, taxReporting: 'None', notes: 'Secondary buyer conditioned on also committing to GP\'s next fund. ILPA guidance cautions against conflicts. Requires independent LPAC vote and conflict-of-interest disclosure.' },
    { code: 'SEC-STRIP', sortOrder: 105, name: 'Equity Strip / Asset Carve-Out', ilpaCategory: 'GP Secondary & Restructuring', ilpaSubtype: 'Secondary — Equity Strip', ilpaTemplateRef: 'ILPA GP-Led Secondary Guidance Apr 2019', direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'Investment Portfolio — Carved Assets', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-SEC-STRIP', perfTemplateClass: 'Distribution', perfTemplateMethod: 'Granular', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'Return of Capital', commitmentImpact: 'No Impact', settlementDays: 'T+10', autoReconcile: false, approvalRequired: true, taxReporting: 'Schedule K-1 — Item 9a', notes: 'Sale of a strip of economics across multiple portfolio companies to a single secondary buyer. Provides diversified exposure. Complex accounting: each underlying asset treated separately for performance.' },
    { code: 'SEC-PREFERRED', sortOrder: 106, name: 'GP-Led Preferred Equity Recapitalization', ilpaCategory: 'GP Secondary & Restructuring', ilpaSubtype: 'Secondary — Preferred Equity Recap', ilpaTemplateRef: 'ILPA GP-Led Secondary Guidance Apr 2019', direction: 'Inflow', insideFund: true, recallable: false, navImpact: 'No NAV Impact', glDebit: 'Cash & Cash Equivalents', glCredit: 'Preferred Equity Interest — Secondary Investor', journalType: 'JE-SEC-PREF', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'Preferred Return', commitmentImpact: 'No Impact', settlementDays: 'T+10', autoReconcile: false, approvalRequired: true, taxReporting: 'None', notes: 'Preferred equity raised from secondary investor at fund level with negotiated return priority. Provides liquidity to exiting LPs without asset sales. Common in end-of-life PE funds.' },
    // ── TAX & REGULATORY ──────────────────────────────────────────────
    { code: 'TAX-WITHHOLD', sortOrder: 110, name: 'Foreign LP Tax Withholding (FIRPTA / Treaty)', ilpaCategory: 'Tax & Regulatory', ilpaSubtype: 'Tax — Foreign Withholding', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'Withholding Tax Expense — Foreign LP', glCredit: 'Tax Withholding Payable (IRS)', journalType: 'JE-TAX-WHT', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+3', autoReconcile: false, approvalRequired: false, taxReporting: 'Form 8804 / 8805 / 1042-S', notes: 'FIRPTA withholding on non-US LP shares of ECI (effectively connected income). Rate typically 10% for distributions; 37% for withholding on EC ordinary income. Treaty rates may reduce. Certified to IRS.' },
    { code: 'TAX-BLOCKER', sortOrder: 111, name: 'Blocker Corporation Tax Expense', ilpaCategory: 'Tax & Regulatory', ilpaSubtype: 'Tax — Blocker Corp', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'Current Income Tax Expense — Blocker', glCredit: 'Income Tax Payable', journalType: 'JE-TAX-BLK', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+0', autoReconcile: true, approvalRequired: false, taxReporting: 'Form 1120', notes: 'Federal and state corporate income tax at blocker corporation level used by tax-exempt (pension, endowment) and foreign LPs to block UBTI. Current and deferred components. Form 1120 filer.' },
    { code: 'TAX-UBTI', sortOrder: 112, name: 'UBTI Allocation / Tax Gross-Up Payment', ilpaCategory: 'Tax & Regulatory', ilpaSubtype: 'Tax — UBTI', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'UBTI Tax Expense', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-TAX-UBTI', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+0', autoReconcile: false, approvalRequired: true, taxReporting: 'Form 990-T / Schedule K-1 — Item 20V', notes: 'Fund-level UBTI from operating businesses, leveraged debt, or certain fee income allocated to tax-exempt LPs. GP may fund gross-up payment per side letter to protect LP\'s tax-exempt status.' },
    { code: 'TAX-FATCA', sortOrder: 113, name: 'FATCA Chapter 4 Withholding', ilpaCategory: 'Tax & Regulatory', ilpaSubtype: 'Tax — FATCA', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'FATCA Withholding Tax Expense', glCredit: 'FATCA Withholding Payable (IRS)', journalType: 'JE-TAX-FATCA', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+3', autoReconcile: false, approvalRequired: false, taxReporting: 'Form 1042 / 1042-S', notes: '30% withholding on withholdable payments to non-participating foreign financial institutions or non-compliant investors. Collected on US-source fixed/determinable payments. W-8/W-9 certification required.' },
    { code: 'TAX-CRS', sortOrder: 114, name: 'CRS / AEOI Information Reporting Fee', ilpaCategory: 'Tax & Regulatory', ilpaSubtype: 'Tax — CRS / AEOI', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'CRS Compliance Expense', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-TAX-CRS', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+30', autoReconcile: true, approvalRequired: false, taxReporting: 'Local CRS / AEOI Filing', notes: 'Costs of Common Reporting Standard / Automatic Exchange of Information compliance — reporting to local tax authorities on investor accounts. Required in 100+ jurisdictions. Annual filing.' },
    { code: 'TAX-STATE', sortOrder: 115, name: 'State & Local Tax (SALT) — Partnership', ilpaCategory: 'Tax & Regulatory', ilpaSubtype: 'Tax — State & Local', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'State & Local Tax Expense', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-TAX-SALT', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+0', autoReconcile: true, approvalRequired: false, taxReporting: 'State Form 3 / IT-204 / Schedule K-1', notes: 'State composite return payments, franchise taxes, and withholding for non-resident LP states. Number of state filings can exceed 20 for nationally diversified PE portfolios.' },
    { code: 'TAX-AIFMD', sortOrder: 116, name: 'AIFMD / MiFID II Regulatory Levy', ilpaCategory: 'Tax & Regulatory', ilpaSubtype: 'Tax — EU Regulatory', ilpaTemplateRef: 'AIFMD Annex IV / MiFID II', direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'EU Regulatory Levy Expense', glCredit: 'Cash & Cash Equivalents', journalType: 'JE-TAX-AIFMD', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+30', autoReconcile: true, approvalRequired: false, taxReporting: 'AIFMD Annex IV / EMIR Report', notes: 'EU Alternative Investment Fund Manager regulatory fees — ESMA levies, national regulator supervision fees, AIFMD passport fees. Applicable to EU-marketed and AIFMD-authorized funds.' },
    // ── VALUATION & ADJUSTMENT ────────────────────────────────────────
    { code: 'VAL-MARK', sortOrder: 120, name: 'Quarterly Fair Value Mark (ASC 820 / IFRS 13)', ilpaCategory: 'Valuation & Adjustment', ilpaSubtype: 'Valuation — Fair Value Mark', ilpaTemplateRef: tpRef, direction: 'Bilateral', insideFund: true, recallable: false, navImpact: 'Bilateral', glDebit: 'Unrealized Appreciation / Depreciation', glCredit: 'Investment Portfolio — Fair Value', journalType: 'JE-VAL-MRK', perfTemplateClass: 'N/A', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+0', autoReconcile: true, approvalRequired: true, taxReporting: 'None', notes: 'Quarterly NAV mark per ASC 820 / IFRS 13 hierarchy (Level 1/2/3). Level 3 requires GP valuation committee approval and independent third-party validation. Drives TVPI and quarterly LP statements.' },
    { code: 'ADJ-UNREAL', sortOrder: 121, name: 'Unrealized Appreciation / Depreciation', ilpaCategory: 'Valuation & Adjustment', ilpaSubtype: 'Adjustment — Unrealized P&L', ilpaTemplateRef: tpRef, direction: 'Bilateral', insideFund: true, recallable: false, navImpact: 'Bilateral', glDebit: 'Unrealized Gain/Loss — Investment', glCredit: 'Investment at Fair Value', journalType: 'JE-ADJ-UNREAL', perfTemplateClass: 'N/A', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+0', autoReconcile: true, approvalRequired: false, taxReporting: 'None', notes: 'Net change in unrealized portfolio value in reporting period. Flows through capital account via income allocation. Drives RVPI metric. Reversed upon realization.' },
    { code: 'ADJ-WRTOFF', sortOrder: 122, name: 'Write-Off / Full Impairment', ilpaCategory: 'Valuation & Adjustment', ilpaSubtype: 'Adjustment — Write-Off', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'Realized Loss on Investment', glCredit: 'Investment Portfolio — Cost Basis', journalType: 'JE-ADJ-WRK', perfTemplateClass: 'N/A', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'Return of Capital', commitmentImpact: 'No Impact', settlementDays: 'T+0', autoReconcile: false, approvalRequired: true, taxReporting: 'Schedule K-1 — Item 9c', notes: 'Full write-off of investment to zero carrying value. Triggers realization in performance tracking — increases realized loss count. Reverses all prior unrealized marks. Requires GP board approval.' },
    { code: 'ADJ-IMPAIR', sortOrder: 123, name: 'Partial Impairment / Valuation Markdown', ilpaCategory: 'Valuation & Adjustment', ilpaSubtype: 'Adjustment — Impairment', ilpaTemplateRef: tpRef, direction: 'Outflow', insideFund: true, recallable: false, navImpact: 'Decrease NAV', glDebit: 'Impairment Loss — Investment', glCredit: 'Investment Portfolio — Fair Value', journalType: 'JE-ADJ-IMP', perfTemplateClass: 'N/A', perfTemplateMethod: 'Both', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+0', autoReconcile: true, approvalRequired: true, taxReporting: 'None', notes: 'Partial markdown of carrying value below cost basis. Unlike write-off, company remains in portfolio. ILPA RT v2.0 requires disclosure of impairment count and cumulative basis reduction.' },
    { code: 'ADJ-RESTAT', sortOrder: 124, name: 'Restatement / Prior Period Correction', ilpaCategory: 'Valuation & Adjustment', ilpaSubtype: 'Adjustment — Restatement', ilpaTemplateRef: tpRef, direction: 'Bilateral', insideFund: true, recallable: false, navImpact: 'Bilateral', glDebit: 'Prior Period Restatement — Dr', glCredit: 'Prior Period Restatement — Cr', journalType: 'JE-ADJ-REST', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+0', autoReconcile: false, approvalRequired: true, taxReporting: 'Amended K-1 may be required', notes: 'Material restatement correcting prior period financial statements. Requires LP notification and re-issuance of affected capital account statements. Triggers re-opening of closed periods in accounting system.' },
    { code: 'ADJ-RECYCLE', sortOrder: 125, name: 'Capital Recycling Entry', ilpaCategory: 'Valuation & Adjustment', ilpaSubtype: 'Adjustment — Capital Recycling', ilpaTemplateRef: tpRef, direction: 'Bilateral', insideFund: true, recallable: false, navImpact: 'No NAV Impact', glDebit: 'Recycled Capital — Available Pool', glCredit: 'Realized Return — Returned to Fund', journalType: 'JE-ADJ-RCYC', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'Return of Capital', commitmentImpact: 'Restores Unfunded', settlementDays: 'T+0', autoReconcile: false, approvalRequired: true, taxReporting: 'None', notes: 'Entry reflecting GP\'s exercise of recycling provision — returned capital from exits re-deployed for new investments. Restores unfunded commitment. LPA must explicitly permit recycling; subject to investment period limits.' },
    { code: 'ADJ-ACCRUE', sortOrder: 126, name: 'Expense Accrual / Prepaid Reversal', ilpaCategory: 'Valuation & Adjustment', ilpaSubtype: 'Adjustment — Accrual', ilpaTemplateRef: tpRef, direction: 'Bilateral', insideFund: true, recallable: false, navImpact: 'Bilateral', glDebit: 'Accrued Expense', glCredit: 'Expense Accrual — Various', journalType: 'JE-ADJ-ACR', perfTemplateClass: 'N/A', perfTemplateMethod: 'N/A', feeOffset: false, feeOffsetType: 'None', waterfallTier: 'N/A', commitmentImpact: 'No Impact', settlementDays: 'T+0', autoReconcile: true, approvalRequired: false, taxReporting: 'None', notes: 'Period-end expense accruals and prepaid amortization entries. Includes management fee accruals, audit accruals, and quarterly true-ups. Routine month-end close entries.' },
  ]});

  console.log('Created extended ILPA transaction parameters (+46 types across GP Secondary, Tax & Regulatory, Valuation & Adjustment categories)');
